...
import { EmailAttachment, EmailTemplate } from '../../../core/models/models';
      ...
      <div class="container">
        ...
        <div class="page-head">
          <div>
            ...
            <p class="text-muted">
              Customize the automatic customer notifications sent from <code>orders&#64;wondercart.pk</code>.
            </p>
          </div>
...
export class AdminEmailsComponent implements OnInit {
  ...
  testRecipient = 'ahsan@wondercart.pk';
