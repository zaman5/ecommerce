...
export const routes: Routes = [
  ...
  { path: 'admin/messages', canActivate: [adminGuard], loadComponent: () => import('./pages/admin/messages/admin-messages.component').then((m) => m.AdminMessagesComponent) },
  ...
  { path: 'admin/jazzcash', canActivate: [adminGuard], loadComponent: () => import('./pages/admin/jazzcash-settings/admin-jazzcash-settings.component').then((m) => m.AdminJazzcashSettingsComponent) },
  { path: 'admin/emails', canActivate: [adminGuard], loadComponent: () => import('./pages/admin/emails/admin-emails.component').then((m) => m.AdminEmailsComponent) },
