...
router.put('/:id', protect, restrictTo('admin'), authenticatedRateLimiter, validateParams(idParamSchema), validateBody(categorySchema), updateCategory);
router.delete('/:id', protect, restrictTo('admin'), authenticatedRateLimiter, validateParams(idParamSchema), deleteCategory);
